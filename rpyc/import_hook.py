...
# -*- coding: utf-8 -*-
"""
Source: http://dangerontheranger.blogspot.com.br/2012/07/how-to-use-sysmetapath-with-python.html
...
class CustomImporter(object):
   ...
   def find_module(self, fullname, path):
      ...
      print "Requested ", fullname," path = ",path
